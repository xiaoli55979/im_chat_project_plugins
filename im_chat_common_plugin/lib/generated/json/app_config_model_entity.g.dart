...
AppConfigModelEntity $AppConfigModelEntityFromJson(Map<String, dynamic> json) {
  ...
  final int? phoneSearchOff = jsonConvert.convert<int>(
      json['phone_search_off']);
  if (phoneSearchOff != null) {
    appConfigModelEntity.phoneSearchOff = phoneSearchOff;
  }
  final int? shortnoEditOff = jsonConvert.convert<int>(
      json['shortno_edit_off']);
  ...
  final int? registerInviteOn = jsonConvert.convert<int>(
      json['register_invite_on']);
  if (registerInviteOn != null) {
    appConfigModelEntity.registerInviteOn = registerInviteOn;
  }
  final int? sendWelcomeMessageOn = jsonConvert.convert<int>(
      json['send_welcome_message_on']);
  if (sendWelcomeMessageOn != null) {
    appConfigModelEntity.sendWelcomeMessageOn = sendWelcomeMessageOn;
  }
  final int? inviteSystemAccountJoinGroupOn = jsonConvert.convert<int>(
      json['invite_system_account_join_group_on']);
  if (inviteSystemAccountJoinGroupOn != null) {
    appConfigModelEntity.inviteSystemAccountJoinGroupOn =
        inviteSystemAccountJoinGroupOn;
  }
  final int? registerUserMustCompleteInfoOn = jsonConvert.convert<int>(
      json['register_user_must_complete_info_on']);
  if (registerUserMustCompleteInfoOn != null) {
    appConfigModelEntity.registerUserMustCompleteInfoOn =
        registerUserMustCompleteInfoOn;
  }
  final int? canModifyApiUrl = jsonConvert.convert<int>(
      json['can_modify_api_url']);
...
Map<String, dynamic> $AppConfigModelEntityToJson(AppConfigModelEntity entity) {
  ...
  data['invite_system_account_join_group_on'] =
      entity.inviteSystemAccountJoinGroupOn;
  data['register_user_must_complete_info_on'] =
      entity.registerUserMustCompleteInfoOn;
