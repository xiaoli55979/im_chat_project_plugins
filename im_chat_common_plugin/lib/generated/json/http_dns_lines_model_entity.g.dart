...
HttpDnsLinesModelEntity $HttpDnsLinesModelEntityFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> $HttpDnsLinesModelEntityToJson(HttpDnsLinesModelEntity entity) {
