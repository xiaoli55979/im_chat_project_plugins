    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 10,),
          MenuItem(onPressed: () {},icon:Icons.import_contacts, title: SlocalAuth.getLocalizaContent(SlocalAuth.of(context).general)),
          ...
          MenuItem(onPressed: () {},icon:Icons.import_contacts, title: SlocalAuth.getLocalizaContent(SlocalAuth.of(context).uploadMalfunction)),
        ],
      ),
    );
  }
