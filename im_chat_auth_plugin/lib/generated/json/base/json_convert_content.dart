...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ForgetPwdEntity>[] is M) {
      return data.map<ForgetPwdEntity>((Map<String, dynamic> e) =>
          ForgetPwdEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (ForgetPwdEntity).toString(): ForgetPwdEntity.fromJson,
  };
